...
\centering
  \begin{tikzpicture}[scale=1]
    ...
    \node[eic] (movephase2) at (2,-2.5) {\begin{tabular}{c}\textcolor{blue}{Editors in chief}\\ move to the volume ``Phase 2''\\ add a comment to initiate Phase 2\\ write a message to the editors\end{tabular}};
    \node[editor] (invitereviewers) at (2,-4.5) {\begin{tabular}{c}\textcolor{blue}{Assigned editors}\\ invite reviewers or allow reviewers to modify rating\\ \textit{option}: ``automatically reinvite reviewers''\end{tabular}};
    ...
    \node[author] (submitrevised) at (5.8,-12) {\begin{tabular}{c}\textcolor{blue}{Authors}\\ submit revised version\end{tabular}};
    \node[editor] (recommendation) at (-1,-12) {\begin{tabular}{c}\textcolor{blue}{Editors}\\ decide\end{tabular}};
    \node[eic] (weeklydigest) at (5.8,-14.5) {\begin{tabular}{c}\textcolor{blue}{Weekly digest}\\ informs editorial board\end{tabular}};
    \node[editor] (discusses) at (2,-16) {\begin{tabular}{c}\textcolor{blue}{Editorial board}\\ discusses through comments\\ for one week\end{tabular}};
    \node[eic] (communicatedecision) at (2,-18) {\begin{tabular}{c}\textcolor{blue}{Editors in chief}\\ communicate decision to the authors\end{tabular}};
    \node[accepting] (accept) at (0,-20) {\ };
    \node[accepting] (reject) at (4,-20) {\ };
