...
\tikzstyle{every node}=[font=\small, auto]
%\tikzstyle{author}=[circle,minimum size=.3cm,draw=gray!90,inner sep=1pt,fill=gray!20,very thick]
\tikzstyle{eic}=[rounded corners=.5,minimum size=.4cm,draw=gray!90,inner sep=1pt,fill=gray!20,very thick]
\tikzstyle{editor}=[rounded corners=.5,minimum size=.4cm,draw=gray!90,inner sep=1pt,fill=gray!20,very thick]
\tikzstyle{reviewer}=[rounded corners=.5,minimum size=.4cm,draw=gray!90,inner sep=1pt,fill=gray!20,very thick]
\tikzstyle{author}=[rounded corners=.5,minimum size=.4cm,draw=gray!90,inner sep=1pt,fill=gray!20,very thick]
...
\tikzstyle{polygon7}=[@state,diamond,minimum height=7.5mm,minimum width=7.5mm]
\tikzstyle{state}=[s-eve]
\tikzstyle{s-author}=[circle6]
\tikzstyle{s-eic}=[square5]
\tikzstyle{s-editor}=[diamond7]
\tikzstyle{s-reviewer}=[polygon7]
