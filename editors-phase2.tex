...
\centering
  \begin{tikzpicture}[scale=1]
    ...
    \node[action] (movephase2) at (2,-2.5) {\begin{tabular}{c}\textcolor{blue}{Editors in chief}\\ add a comment to initiate Phase 2\\ write a message to the editors\end{tabular}};
