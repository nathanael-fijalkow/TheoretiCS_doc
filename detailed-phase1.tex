...
\centering
  \begin{tikzpicture}
    ...
    \node[action] (announceeditors) at (5,-12) {\begin{tabular}{c}\textcolor{blue}{Editors in chief}\\ add a comment to \\ announce the editors\\ and let the authors know\end{tabular}};
